    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-800 font-medium mb-2">LayrLabs</h6>
            <ul className="text-sm">
              <li className="mb-2">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-sm text-gray-600 mb-4">Please enter your email to join our newsletter.</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            ...
            <li className="ml-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="30" fill="currentColor" class="bi bi-discord" viewBox="0 0 16 16">
